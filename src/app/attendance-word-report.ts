...
const REPORT_TITLE = "GarmentLine Full Attendance Verification Report";
const DAILY_SUMMARY_REPORT_TITLE = "GarmentLine Daily Attendance Summary Report";
...
export function downloadFullAttendanceWordReport(input: AttendanceWordReportInput) {
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <p>
          This report combines the current GarmentLine attendance state, employee verification
        ...
        ${section(
          ...
          "Reconciled face and fingerprint event history available in GarmentLine.",
          table(
            [
              "Date",
              "Employee No",
        ...
        ${section(
          ...
          "Face attendance events currently reconciled inside GarmentLine.",
          table(
        ...
        ${section(
          ...
          "Fingerprint attendance events currently reconciled inside GarmentLine.",
          table(
            ["Event Time", "Employee No", "Employee Name", "Department", "Gate", "Confidence", "Outcome"],
        ...
        ${section(
          ...
          "Face events that did not match a registered GarmentLine employee record.",
          table(
            [
              "Event Time",
              "Device Employee No / Serial",
        ...
        ${section(
          ...
          "Fingerprint punches whose device PIN is not matched to a registered GarmentLine employee.",
          table(
            [
              "Event Time",
              "PIN",
        ...
        ${section(
          ...
          "Device PINs counted in fingerprint attendance but not yet registered in GarmentLine.",
          table(
        ...
        <p class="small">
          End of report. Generated by GarmentLine Operations Centre.
        </p>
      </body>
    </html>
  `;
  ...
  downloadWordDocument(
    `garmentline-full-attendance-report-${filenameDate(
